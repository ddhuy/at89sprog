...
typedef enum AT89S_EID_t
{
    ...
    AT89S_EID_HEXIO_READ,
    AT89S_EID_HEXIO_LENGTH,
    AT89S_EID_HEXIO_EOF,
    AT89S_EID_HEXIO_CHECKSUM,
    AT89S_EID_HEXIO_RECORD_FORMAT,
    AT89S_EID_HEXIO_RECORD_TYPE,
    AT89S_EID_HEXIO_RECORD_MAX,
    AT89S_EID_HEXIO_RECORD_CHECKSUM,
    AT89S_EID_HEXIO_RECORD_CORRUPT,
    AT89S_EID_HEXIO_BUFFER,
